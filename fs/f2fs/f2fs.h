...
struct f2fs_dir_entry *find_target_dentry(struct qstr *, int *,
						struct f2fs_dentry_ptr *);
bool f2fs_fill_dentries(struct file *, struct f2fs_dentry_ptr *,
			unsigned int, void *, filldir_t, unsigned int *);
...
int f2fs_read_inline_dir(struct file *, void *, filldir_t, unsigned int *);
#endif
